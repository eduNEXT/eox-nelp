...
from eox_nelp.api_clients.tests import TestOauth2AuthenticatorMixin, TestRestApiClientMixin


class TestFuturexApiClient(TestRestApiClientMixin, TestOauth2AuthenticatorMixin, unittest.TestCase):
